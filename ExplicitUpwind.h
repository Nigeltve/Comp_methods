#ifndef EXPLICITUPWING_H
#define EXPLICITUPWING_H
...
public:
	...
	*/
	ExplicitUpwind(double dx, double dt, double L, double timeStop, double U);
	...
	*/
	...
	/**
	* based on the given value of the instance for the Explicit upwind scheme.
