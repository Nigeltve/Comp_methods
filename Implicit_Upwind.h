#ifndef IMPLICIT_UPWIND_H
#define IMPLICIT_UPWIND_H
...
public:
	...
	*/
	Implicit_Upwind(double dx, double dt, double L, double timeStop, double U);
	...
	*/
	...
	/**
	* based on the given value of the instance for the Implicit upwind scheme.
