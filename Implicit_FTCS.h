...
#ifndef IMPLICIT_FTCS_H
#define IMPLICIT_FTCS_H
...
class Implicit_FTCS : public Scheme
{
public:
	/**
	...
	*/
	Implicit_FTCS(double dx, double dt, double L, double timeStop, double U);
	...
	*/
	...
	/**
	* based on the given value of the instance for the Implicit FTCS scheme.
