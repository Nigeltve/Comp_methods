...
Implicit_Upwind::Implicit_Upwind(double dx, double dt, double L, double timeStop, double U)
{
...
std::vector<std::vector<double>> Implicit_Upwind::Theoretical_Sol()
{
	std::cout << "doing the Implicit Upwind Theoretical Solution!" << std::endl;
	...
	//creasts a matrix to put the calculated values for matrix -> C'
